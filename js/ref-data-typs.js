...
console.log("==================================");
// TODO: 배열 중간 원소 접근 실습
// 변수 numbers2에 100, 200, 300, 400, 500을 담은 배열을 할당하고 출력한다
// 세 번째 원소를 출력한다
...
letters.push("Z");
console.log(letters);
let deleted = letters.pop();
console.log(`제거된 원소: ${deleted}, 배열: ${letters}`);
console.log(letters);
/* 출력 결과
['A', 'B']
['A', 'B', 'Z']
...
// 변수 person2에 name: "이민수", age: 35, city: "부산" 속성을 가진 객체를 할당한다
// 객체의 모든 키를 배열로 출력한다
// 객체의 모든 값을 배열로 출력한다
...
// 배열의 요소를 순회하기 위해서는 일반적으로 for...of 문을 사용함
// 각 element 하나가 객체 하나
for (const element of memoList) {
